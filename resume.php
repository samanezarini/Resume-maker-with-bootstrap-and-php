...
if(isset($_POST['submit'])){
    ...
    if(!empty($_POST['social_name']) && $_POST['social_name'][0]!='') {
    ...
    //education
    if(!empty($_POST['section']) && $_POST['section'][0]!=''){
    ...
    //jobs
    if(!empty($_POST['job_title']) && $_POST['job_title'][0]!=''){
    ...
    //language
    if(!empty($_POST['lang_name']) && $_POST['lang_name'][0]!=''){
    ...
    //expertice
    if(!empty($_POST['ex_name']) && !empty($_POST['ex_level']) && $_POST['ex_name'][0]!=''){
    ...
    //evidence
    if(!empty($_POST['evidence_name']) && $_POST['evidence_name'][0]!=''){
    ...
    //project
    if(!empty($_POST['project_name']) && $_POST['project_name'][0]!=''){
    ...
    //research
    if(!empty($_POST['research_name']) && $_POST['research_name'][0]!=''){
    ...
    //honor
    if(!empty($_POST['honor_name']) && $_POST['honor_name'][0]!=''){
    ...
    //representative
    if(!empty($_POST['rep_name']) && $_POST['rep_name'][0]!=''){
                        ...
                        <div class="card-body py-5 px-md-5">
							...
							<div class="col-md-3">
								<div class="col-sm-12 text-center">
                                    <span id="preview">
									<img class="w-50 rounded-circle img-thumbnail" <?=$rows['user_pic']==''?'src="images/user.png"':'src="images/users/'.$rows['user_pic'].'"'?>></span>
                                    <input class="btn btn-success choose-file" type="file" name="file" id="file">
                                    <label for="file" class="upload-file mt-4" style="width=20%;height:20%"><img src="images/image" style="width:20%; height:10%"></label>
                                ...
                                <div class="col-md-2 mb-4">
                                    <label class="form-label">: تاهل</label>
    ...
    <div class="container">
        <div class="row align-items-center center mb-5">
            <div class="col-lg-12 mb-5 mb-lg-0 ">
				...
				<div class="col-md-12 text-center" style="margin-top: 31px;">
    ...
    <fieldset>
        <div class="form-card">
            ...
            <div class="container">
                <div class="row align-items-center center">
                    <div class="col-lg-12 mb-5 mb-lg-0">
                        <p class="me-1 mt-4">سوابق شغلی</p>
                        <div class="card shadow" id="form-r">
                        <?php
                        ...
                        foreach ($j_rows as $r){ ?>
                                <div class="card-body py-5 px-md-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mt-5 jobrows" style="direction: rtl; text-align: right;">
						...
						<div class="col-md-12 text-center">
                                <a id="jobadd" class="btn" style="margin-top:45px;">
                                    <img src="images/plus.png" alt="plus" style="width:30px; height:30px;" />
                                </a>
                         </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            <div class="form-outline">
                                                ...
                                                <input value="<?=$r['evidence_name']?>" name="evidence_name[]" type="text" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-4 mt-2">
